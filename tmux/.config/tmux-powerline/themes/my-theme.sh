...
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-'188'}
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
  TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
    "tmux_session_info 108 234"
    "hostname 67 234"
    #"mode_indicator 165 0"
    #"ifstat 30 255"
    #"ifstat_sys 30 255"
    #"lan_ip 74 234 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
  TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
    ...
    #"xkb_layout 125 117"
    "date_day 108 234"
    "date 108 234 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
    "time 108 234 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
